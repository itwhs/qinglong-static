...
exports.default = (app) => {
    ...
    route.post('/views', (0, celebrate_1.celebrate)({
        body: celebrate_1.Joi.object({
            ...
            sorts: celebrate_1.Joi.string().optional(),
            filters: celebrate_1.Joi.string().optional(),
        }),
    }), async (req, res, next) => {
        try {
            const cronViewService = typedi_1.Container.get(cronView_1.default);
    ...
    route.get('/', (0, celebrate_1.celebrate)({
        query: celebrate_1.Joi.object({
            ...
            sortField: celebrate_1.Joi.string().optional(),
            sortType: celebrate_1.Joi.string().optional(),
